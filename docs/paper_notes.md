...
> sagittal-T2 sequence vs full 3D volumes with multi-sequence input; (iii) backbone, a
> frozen natural-image-pretrained DINOv2 ViT-S/14 with a ~1.8M-parameter trainable head
